...
pub fn save<P: AsRef<Path>>(img: &DynamicImage, path: P) -> Result<()> {
...
pub fn byte2img(data: &[u8], width: u32, height: u32) -> Result<DynamicImage> {
...
/// image to byte
pub fn img2byte(img: &DynamicImage) -> Vec<u8> {
